...
public class FrmProveedor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblc.setFont(new java.awt.Font("Montserrat", 1, 14)); // NOI18N
        ...
        categoria.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/pez72.png"))); // NOI18N
        ...
        txtPagina.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Página web", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Montserrat", 1, 14), new java.awt.Color(102, 102, 102))); // NOI18N
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(txtPagina, javax.swing.GroupLayout.PREFERRED_SIZE, 571, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED))
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        tblProveedores.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id ", "RFC", "Nombre", "Dirección", "Teléfono", "Página web"
            }
        ) {
    ...
    private void categoriaMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_categoriaMouseEntered
        categoria.setIcon(new ImageIcon("imagenes\\pez72n.png"));
    ...
    private void categoriaMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_categoriaMouseExited
        categoria.setIcon(new ImageIcon("imagenes\\pez72.png"));
    ...
    private void categoriaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_categoriaMouseClicked
        if (!hayCliente()) {
            ...
            JOptionPane.showMessageDialog(this, "No existe ningun cliente registrado registrado", "Información", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void txtPaginaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPaginaKeyTyped
        if (txtTelefono.getText().length() == 500) {
            evt.consume();
        }
    ...
    private void guardarProveedor() {
        if (!camposVacios()) {
            ...
            String paginaWeb = this.txtPagina.getText();
            Proveedor proveedor = new Proveedor(RFC, nombre, direccion, telefono, paginaWeb);
            if (controlProveedores.guardar(proveedor)) {
    ...
    private void actualizarProveedor() {
        if (!camposVacios()) {
            ...
            String telefono = this.txtTelefono.getText();
            String paginaWeb = this.txtPagina.getText();
            Proveedor proveedor = new Proveedor(id, RFC, nombre, direccion, telefono, paginaWeb);
            if (controlProveedores.actualizar(proveedor)) {
    ...
    private void eliminarProveedor() {
        ...
        if (fila == -1) {
            ...
            if (controlProveedores.eliminar(idProveedor)) {
                ...
                JOptionPane.showMessageDialog(this, "No se logro eliminar al proveedor.",
                        "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    private void llenarTablaProveedores() {
        ...
        listaProveedores = controlProveedores.buscarTodas(Busqueda);
    ...
    private void cargarProveedor() {
        ...
        if (fila == -1) {
            ...
            DefaultTableModel modelo = (DefaultTableModel) this.tblProveedores.getModel();
            Integer idProveedor = (Integer) modelo.getValueAt(fila, 0);
            Proveedor proveedor = controlProveedores.buscarporID(idProveedor);
            if (proveedor != null) {
                this.txtId.setText(String.valueOf(proveedor.getIdproveedor()));
                ...
                this.txtPagina.setText(proveedor.getPaginaWeb());
            } else {
    ...
    private void buscarLike() {
        String Busqueda = txtBusqueda.getText();
        listaProveedores = controlProveedores.buscarLike(Busqueda);
        DefaultTableModel modelo = (DefaultTableModel) tblProveedores.getModel();
        modelo.setRowCount(0);
        for (Proveedor proveedor : listaProveedores) {
            modelo.addRow(proveedor.toArray());
